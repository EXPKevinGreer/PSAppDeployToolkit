...
NOTICE: This function is a modification of the Show-BalloonTip function in the PSAppDeployToolkit, with added functionality to support to Detect Zoom and Microsoft Teams presentations.
